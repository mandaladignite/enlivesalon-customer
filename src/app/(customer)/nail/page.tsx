      ...
      <div className="relative bg-gradient-to-br from-yellow-50 via-white to-amber-50 py-20 mb-16 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              Discover our comprehensive nail services designed to make your hands and feet look beautiful and well-groomed. 
              Experience the perfect blend of artistry and care.
            </motion.p>
      ...
      <div className="container mx-auto px-6 mb-20">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Our expert nail technicians and premium products ensure you get the best results for your nails. 
            We combine artistic creativity with professional care for stunning results.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              description: "Our certified nail technicians have years of experience and advanced training in nail artistry.",
            ...
            },
            {
              ...
              description: "We use only the highest quality professional nail products from top brands.",
              bgColor: "bg-amber-50",
              iconBg: "bg-amber-100"
            },
            {
              ...
              description: "Stay current with the latest trends and innovative techniques in nail care and design.",
              bgColor: "bg-yellow-50",
              iconBg: "bg-yellow-100"
            },
            {
              ...
              description: "Customized treatments and designs tailored to your style and nail health needs.",
              bgColor: "bg-amber-50",
              iconBg: "bg-amber-100"
            }
          ].map((benefit, index) => (
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover our most popular nail treatments that our clients love and book repeatedly.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                duration: "60 min",
                price: "₹1,200",
                description: "Long-lasting gel manicure with beautiful color and shine that lasts up to 3 weeks.",
              ...
              },
              {
                ...
                duration: "90 min",
                price: "₹1,800",
                description: "Relaxing pedicure with foot spa, exfoliation, and nail care for healthy feet.",
                image: "/nailservice.jpg"
              },
              {
                ...
                duration: "75 min",
                price: "₹1,500",
                description: "Creative nail art designs with premium colors and artistic techniques.",
                image: "/nailservice.jpg"
              }
            ].map((service, index) => (
              <motion.div
              ...
              >
                <div className="h-48 bg-gradient-to-br from-yellow-100 to-amber-100 flex items-center justify-center">
                  <Sparkles className="w-16 h-16 text-yellow-400 group-hover:scale-110 transition-transform duration-300" />
                </div>
                <div className="p-6">
