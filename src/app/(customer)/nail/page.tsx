    ...
    <section className="w-full mt-16 bg-white">
      ...
      <div className="container mx-auto px-6 text-center mb-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">About Our Nail Services</h2>
          <p className="text-lg text-gray-600 max-w-3xl mb-6">
            Pamper your hands and feet with our full range of nail care services, from classic manicures to top-trending nail art and gel extensions. Our talented nail artists use the highest quality products for hygienic, beautiful, and long-lasting results every visit.
          </p>
        </motion.div>
      </div>
