    ...
    <section className="w-full mt-16 bg-white">
      ...
      <div className="container mx-auto px-6 text-center mb-16">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">About Our Hair Services</h2>
          <p className="text-lg text-gray-600 max-w-3xl mb-6">
            Discover premium hair services including styling, cutting, coloring, and treatments. Our expert stylists use the latest techniques and top products to ensure you leave our salon looking and feeling your best. Whether you want a fresh cut, bold color, or a nourishing treatment, Enlive delivers luxury and style every time.
          </p>
        </motion.div>
      </div>
      ...
      <ServiceReviews 
        ...
        limit={6}
        showFeatured={true}
        title="What Our Hair Clients Say"
        subtitle="Don't just take our word for it. Here's what our satisfied clients have to say about their hair service experience."
      />
